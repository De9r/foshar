...
async def start(app, message):
	...
	await app.send_message(message.chat.id,"""اهلا بك في بوت البحث في موقع فشار... 
اكتب
/movie وقربه اسم الفيلم بأحرف سمول فقط يعني (a مو A)
وانتبه اذا بالاسم فراغ خلي بدل الفراغ -

امثلة على الاستخدام:
/movie fury

اذا كان فيه فراغ يعني هيج fight club تبدل الفراغ ب (-) يعني تكتب هيج 
